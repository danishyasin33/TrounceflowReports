...
with doc.create(Section('Other Government Debt')):
    with doc.create(Tabular('l|l|r|r')) as table:
        table.add_row(('Date', 'Type', 'USD bn (Total)','ARS bn (Total)'))
        table.add_hline()
        #June
...
with doc.create(Section('External Sector')):
    with doc.create(Subsection('External Debt')):
        with doc.create(Tabular('l|l|r|r')) as table:
            table.add_row(('Date','Type', 'USD bn (Total)','ARS bn (Total)'))
            table.add_hline()
            #June
            table.add_row(MultiRow(2,data='Jun 2019'), 'Insur. Companies', dfJunInsUSD['Total'].values[0], dfJunInsARS['Total'].values[0])
    ...
    #FX Reservers - Section 1.4
    with doc.create(Subsection('FX Reserves')):
        with doc.create(Tabular('l|l|r|r')) as table:
            table.add_row(('Date', 'Type', 'USD bn (Total)','ARS bn (Total)'))
            table.add_hline()
            #Sep
